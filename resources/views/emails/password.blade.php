...
<html>
<head>
    <title>Alta de Usuario en el Portal Between Technology</title>
    <meta charset="utf-8" />
    <style>
        /* -------------------------------------
            GLOBAL
    ...
    <table class="body-wrap">
        <tr>
            ...
            <td class="container" width="600">
                <div class="content">
                    <table class="main" style="width: 100%" cellpadding="0" cellspacing="0">
                        <tr>
                            <td class="content-wrap">
                                <table cellpadding="0" cellspacing="0" style="width: 100%">
                                    ...
                                    <tr>
                                        <td class="content-block">
                                            <br /><br />
                                            <span style="font-style: italic; font-size: 70%;">Este email se envió desde una dirección exclusiva para notificaciones y no puede recibir emails entrantes.<br />POR FAVOR NO RESPONDA a este mensaje.</span>
                                        </td>
                                    </tr>
                                </table>
                            </td>
