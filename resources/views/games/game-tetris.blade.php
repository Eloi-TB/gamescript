...
<style>
   ...
   #canvas   {  vertical-align: top; background: url(texture.jpg); box-shadow: 10px 10px 10px #999; border: 2px solid #333; }
   #menu     { display: inline-block; vertical-align: top; position: absolute; padding: 6em;top:5px;left:5px;  vertical-align: middle; }
   #menu p   { margin: 0.5em 0; text-align: center; }
   #menu p a { text-decoration: none; color: black; }
   #upcoming { display: block; margin: 0 auto; background-color: #E0E0E0; }
   #score    { color: red; font-weight: bold; vertical-align: middle; }
   #rows     { color: blue; font-weight: bold; vertical-align: middle; }
   #stats    { position: relative; bottom: 0em; right: 1em; }
...
<!--- Div en el que se muestra el juego ---->
 ...
 <div id="tetris" style="padding: 10px;">
